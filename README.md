# AREX — Sistema de Inteligencia Personal · MARK IV (v178)
...
├── sw.js               → Service Worker v178 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v178 | Instalable, network-first para shell, cache offline |
