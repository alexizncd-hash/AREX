# AREX — Sistema de Inteligencia Personal · MARK IV (v180)
...
├── sw.js               → Service Worker v180 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v180 | Instalable, network-first para shell, cache offline |
