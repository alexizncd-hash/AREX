# AREX — Sistema de Inteligencia Personal · MARK IV (v196)
...
├── sw.js               → Service Worker v196 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v196 | Instalable, network-first para shell, cache offline |
