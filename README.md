# AREX — Sistema de Inteligencia Personal · MARK IV (v179)
...
├── sw.js               → Service Worker v179 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v179 | Instalable, network-first para shell, cache offline |
