# AREX — Sistema de Inteligencia Personal · MARK IV (v173)
...
├── sw.js               → Service Worker v173 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v173 | Instalable, network-first para shell, cache offline |
