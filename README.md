# AREX — Sistema de Inteligencia Personal · MARK IV (v170)
...
├── sw.js               → Service Worker v170 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v170 | Instalable, network-first para shell, cache offline |
