# AREX — Sistema de Inteligencia Personal · MARK IV (v176)
...
├── sw.js               → Service Worker v176 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v176 | Instalable, network-first para shell, cache offline |
