# AREX — Sistema de Inteligencia Personal · MARK IV (v198)
...
├── sw.js               → Service Worker v198 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v198 | Instalable, network-first para shell, cache offline |
