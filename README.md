# AREX — Sistema de Inteligencia Personal · MARK IV (v197)
...
├── sw.js               → Service Worker v197 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v197 | Instalable, network-first para shell, cache offline |
