# AREX — Sistema de Inteligencia Personal · MARK IV (v192)
...
├── sw.js               → Service Worker v192 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v192 | Instalable, network-first para shell, cache offline |
