# AREX — Sistema de Inteligencia Personal · MARK IV (v165)
...
├── sw.js               → Service Worker v165 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v165 | Instalable, network-first para shell, cache offline |
