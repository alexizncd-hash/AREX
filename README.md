# AREX — Sistema de Inteligencia Personal · MARK IV (v208)
...
├── sw.js               → Service Worker v208 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v208 | Instalable, network-first para shell, cache offline |
