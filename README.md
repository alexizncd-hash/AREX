# AREX — Sistema de Inteligencia Personal · MARK IV (v171)
...
├── sw.js               → Service Worker v171 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v171 | Instalable, network-first para shell, cache offline |
