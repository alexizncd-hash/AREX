# AREX — Sistema de Inteligencia Personal · MARK IV (v188)
...
├── sw.js               → Service Worker v188 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v188 | Instalable, network-first para shell, cache offline |
