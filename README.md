# AREX — Sistema de Inteligencia Personal · MARK IV (v132)
...
├── sw.js               → Service Worker v132 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v132 | Instalable, network-first para shell, cache offline |
