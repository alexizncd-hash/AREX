# AREX — Sistema de Inteligencia Personal · MARK IV (v168)
...
├── sw.js               → Service Worker v168 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v168 | Instalable, network-first para shell, cache offline |
