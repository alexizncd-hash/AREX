# AREX — Sistema de Inteligencia Personal · MARK IV (v184)
...
├── sw.js               → Service Worker v184 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v184 | Instalable, network-first para shell, cache offline |
