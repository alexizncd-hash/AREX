# AREX — Sistema de Inteligencia Personal · MARK IV (v177)
...
├── sw.js               → Service Worker v177 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v177 | Instalable, network-first para shell, cache offline |
