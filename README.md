# AREX — Sistema de Inteligencia Personal · MARK IV (v195)
...
├── sw.js               → Service Worker v195 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v195 | Instalable, network-first para shell, cache offline |
