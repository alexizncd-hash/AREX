# AREX — Sistema de Inteligencia Personal · MARK IV (v172)
...
├── sw.js               → Service Worker v172 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v172 | Instalable, network-first para shell, cache offline |
