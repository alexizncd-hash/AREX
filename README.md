# AREX — Sistema de Inteligencia Personal · MARK IV (v203)
...
├── sw.js               → Service Worker v203 (PWA / modo offline / cache network-first)
...
| **CTRL** | ⊡ | Mission Control: telemetría, bitácora, escuadrón de 5 agentes (ESPECTRO infiltrado incluido) con barrido total e historial, exportar/importar datos |
...
| PWA + Service Worker v203 | Instalable, network-first para shell, cache offline |
