# AREX — Sistema de Inteligencia Personal · MARK IV (v207)
...
├── sw.js               → Service Worker v207 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v207 | Instalable, network-first para shell, cache offline |
