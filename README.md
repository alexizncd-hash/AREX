# AREX — Sistema de Inteligencia Personal · MARK IV (v200)
...
├── sw.js               → Service Worker v200 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v200 | Instalable, network-first para shell, cache offline |
