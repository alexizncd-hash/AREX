# AREX — Sistema de Inteligencia Personal · MARK IV (v133)
...
├── sw.js               → Service Worker v133 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v133 | Instalable, network-first para shell, cache offline |
