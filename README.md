# AREX — Sistema de Inteligencia Personal · MARK IV (v175)
...
├── sw.js               → Service Worker v175 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v175 | Instalable, network-first para shell, cache offline |
