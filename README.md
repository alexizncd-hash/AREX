# AREX — Sistema de Inteligencia Personal · MARK IV (v182)
...
├── sw.js               → Service Worker v182 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v182 | Instalable, network-first para shell, cache offline |
