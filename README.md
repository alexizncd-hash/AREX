# AREX — Sistema de Inteligencia Personal · MARK IV (v193)
...
├── sw.js               → Service Worker v193 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v193 | Instalable, network-first para shell, cache offline |
