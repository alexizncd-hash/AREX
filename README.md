# AREX — Sistema de Inteligencia Personal · MARK IV (v174)
...
├── sw.js               → Service Worker v174 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v174 | Instalable, network-first para shell, cache offline |
