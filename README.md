# AREX — Sistema de Inteligencia Personal · MARK IV (v211)
...
├── sw.js               → Service Worker v211 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v211 | Instalable, network-first para shell, cache offline |
