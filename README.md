# AREX — Sistema de Inteligencia Personal · MARK IV (v199)
...
├── sw.js               → Service Worker v199 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v199 | Instalable, network-first para shell, cache offline |
