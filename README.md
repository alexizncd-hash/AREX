# AREX — Sistema de Inteligencia Personal · MARK IV (v191)
...
├── sw.js               → Service Worker v191 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v191 | Instalable, network-first para shell, cache offline |
