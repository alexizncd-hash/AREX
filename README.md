# AREX — Sistema de Inteligencia Personal · MARK IV (v135)
...
├── sw.js               → Service Worker v135 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v135 | Instalable, network-first para shell, cache offline |
