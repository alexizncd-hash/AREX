# AREX — Sistema de Inteligencia Personal · MARK IV (v189)
...
├── sw.js               → Service Worker v189 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v189 | Instalable, network-first para shell, cache offline |
