# AREX — Sistema de Inteligencia Personal · MARK IV (v206)
...
├── sw.js               → Service Worker v206 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v206 | Instalable, network-first para shell, cache offline |
