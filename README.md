# AREX — Sistema de Inteligencia Personal · MARK IV (v181)
...
├── sw.js               → Service Worker v181 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v181 | Instalable, network-first para shell, cache offline |
