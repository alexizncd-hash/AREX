# AREX — Sistema de Inteligencia Personal · MARK IV (v190)
...
├── sw.js               → Service Worker v190 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v190 | Instalable, network-first para shell, cache offline |
