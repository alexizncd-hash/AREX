# AREX — Sistema de Inteligencia Personal · MARK IV (v194)
...
├── sw.js               → Service Worker v194 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v194 | Instalable, network-first para shell, cache offline |
