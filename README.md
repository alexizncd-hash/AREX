# AREX — Sistema de Inteligencia Personal · MARK IV (v169)
...
├── sw.js               → Service Worker v169 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v169 | Instalable, network-first para shell, cache offline |
