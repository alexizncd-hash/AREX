# AREX — Sistema de Inteligencia Personal · MARK IV (v134)
...
├── sw.js               → Service Worker v134 (PWA / modo offline / cache network-first)
...
| PWA + Service Worker v134 | Instalable, network-first para shell, cache offline |
